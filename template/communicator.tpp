...
template <class Ty> Communicator<Ty>::Communicator() {
...
template <class Ty> int Communicator<Ty>::size() const { return this->size_; }

template <class Ty> int Communicator<Ty>::rank() const { return this->rank_; }

template <class Ty> MPI_Datatype Communicator<Ty>::mpi_type() const {
...
template <class Ty> void Communicator<Ty>::barrier(MPI_Comm comm) {
    MPI_Barrier(comm);
}